<div class="line-item container">
    ...
    <div class="input-wrapper vertical sm-input">
        ...
        <input type="text" id="misc-cost" class="misc-cost numeric" name="misc-cost[]"/>
    </div>
    <div class="input-wrapper vertical sm-input">
        <label for="misc-price">Price</label>
        <input type="text" id="misc-price" class="misc-price numeric" name="misc-price[]"/>
    </div>
    <div class="input-wrapper vertical sm-input">
        <label for="misc-quantity">Quantity</label>
        <input type="text" id="misc-quantity" class="misc-quantity numeric" name="misc-quantity[]"/>
    </div>
