<div id="misc-line-item" class="line-item container">
    <div class="input-wrapper vertical">
        <label for="misc-description">Description</label>
        <input type="text" id="misc-description" name="misc-description"/>
    </div>
    <div class="input-wrapper vertical">
        <label for="misc-cost">Cost</label>
        <input type="number" id="misc-cost" name="misc-cost" min="0.00" step="0.01"/>
    </div>
    <div class="input-wrapper vertical">
        <label for="misc-price">Price</label>
        <input type="text" id="misc-price" name="misc-price"/>
    </div>
    <div class="input-wrapper vertical">
        <label for="misc-quantity">Quantity</label>
        <input type="text" id="misc-quantity" name="misc-quantity"/>
    </div>
    <div class="input-wrapper vertical">
